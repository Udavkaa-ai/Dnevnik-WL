...
export const TOUR_STEPS = [
  ...
  },
  {
    ...
    description: 'Каждый день разделён на отдельную карточку. Нажми на задачу, чтобы отметить её выполненной. Прогресс виден в виде счётчика.',
  ...
  },
  {
    ...
    description: 'Нажми «+» рядом с датой, чтобы быстро добавить задачу на этот день.',
    tooltipPosition: 'bottom',
  },
  {
    id: 'ai_analysis',
  ...
  },
  {
    ...
    description: 'Здесь все задачи сгруппированы по датам: просроченные, сегодня, запланированные, без даты. Нажми «+», чтобы добавить задачу на любую дату.',
    tooltipPosition: 'top',
  },
  {
    id: 'tasks_actions',
    ...
    description: 'Нажми на задачу — отметить выполненной. Удержи или нажми «•••» — появится меню: перенести на другую дату, убрать без даты или отменить.',
    tooltipPosition: 'center',
  },
  {
    id: 'diary_screen',
    ...
    description: 'Здесь хранятся все записи дневника с оценками настроения. Нажми на запись, чтобы прочитать её полностью. Через календарь (кнопка внизу справа) можно добавить запись за любую прошедшую дату.',
    tooltipPosition: 'center',
  },
  {
    id: 'stats_screen',
  ...
  {
    id: 'menu_and_settings',
    tab: null,
    targetRef: null,
    title: '☰ Меню и настройки',
    description: 'Нажми «≡» в левом верхнем углу — откроется боковое меню со всеми разделами приложения.\n\nВ Настройках раздел «Данные»:\n• Экспорт/импорт .ics — синхронизация с Google Calendar и другими\n• Бэкап с фото — полная копия всех записей и фотографий',
    tooltipPosition: 'center',
  },
  {
    id: 'done',
